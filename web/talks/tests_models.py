...
class ChannelModelTests(TestCase):
    ...
    def test_instance_get_youtube_null_url(self):
        """All Channel models have a property that returns the external
        youtube url If the code is not set the youtube url will be '-'.
        """
...
class TalkModelTests(TestCase):
    ...
    def test_instance_thumbnails(self):
        ...
        self.assertEquals(talk.default_thumb,
                          'https://i.ytimg.com/vi/1234/default.jpg')
        self.assertEquals(talk.medium_thumb,
                          'https://i.ytimg.com/vi/1234/mqdefault.jpg')
        self.assertEquals(talk.high_thumb,
                          'https://i.ytimg.com/vi/1234/hqdefault.jpg')
        self.assertEquals(talk.standard_thumb,
                          'https://i.ytimg.com/vi/1234/sddefault.jpg')
        self.assertEquals(talk.maxres_thumb,
                          'https://i.ytimg.com/vi/1234/maxresdefault.jpg')
