...
- Refactor auth urls on its app. [Raül Pérez]
- Moar todos. [Raül Pérez]
- Using named urls. [Raül Pérez]
- Blank and null are false by default. [Raül Pérez]
- Using virtualenv. [Raül Pérez]
- Initial work on the templates. [Raül Pérez]
- Properly authenticate and logout user on the system. [Raül Pérez]
- After login session has user_id. [Raül Pérez]
- Moar fixmes. [Raül Pérez]
- Login with Twitter. [Raül Pérez]
- Added user profiles. [Raül Pérez]
- Initial templates front. [Raül Pérez]
- Support for video thumbnails. [Raül Pérez]
- Refactor readonly_fields and moved them to the model. [Raül Pérez]
- Cleanup. [Raül Pérez]
- Get uploaded videos from a channel. [Raül Pérez]
- Refactor crawler. [Raül Pérez]

  - Added subcommands pattern CLI
  - Ported add video to the video command
  - Fix date creation for channels
- Scripts -> crawler. [Raül Pérez]
- Better admin interface for Taks and Channels. [Raül Pérez]
- Better ordering on admin. [Raül Pérez]
- Readonly field for channel url. [Raül Pérez]
- Better admin and url readonly for talks. [Raül Pérez]
- Add videos from a channel. [Raül Pérez]
- Fetch channel. [Raül Pérez]
- Refactor fetching data from API. [Raül Pérez]
- Refactored skeleton script. [Raül Pérez]
- Refactor constants. [Raül Pérez]
- Script support arguments. [Raül Pérez]
- Initial script to add talks. [Raül Pérez]
- Channels, tasks and script skeleton. [Raül Pérez]
- Lint PEP8. [Raül Pérez]
- Upraded to Django 2.0. [Raül Pérez]
- Added nginx proxy. [Raül Pérez]
- Small image. [Raül Pérez]
- Update. [Raül Pérez]
- Better start web. [Raül Pérez]
- Added slug. [Raül Pérez]
- Update. [Raül Pérez]
- New model. [Raül Pérez]
- Talk  -> talks. [Raül Pérez]
- App for talks. [Raül Pérez]
- Migration and superuser º. [Raül Pérez]
- Web uses posgresql. [Raül Pérez]
- Django skeleton dployed. [Raül Pérez]
- Added django web skel. [Raül Pérez]
- Styles. [Raül Pérez]
- Added postgres in a container. [Raül Pérez]
- Initial source code. [Raül Pérez]
- Initial commit. [Raül Pérez]
